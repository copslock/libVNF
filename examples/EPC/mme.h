...
ecm_state=0; /* EPS Connection Management state */
imsi=0; /* International Mobile Subscriber Identity */
ip_addr="";
enodeb_s1ap_ue_id=0; /* eNodeB S1AP UE ID */
mme_s1ap_ue_id=0; /* MME S1AP UE ID */
tai=0; /* Tracking Area Identifier */
//tai_list=0; /* Tracking Area Identifier list */
//tai_list.resize(1); //may8
tau_timer=0; /* Tracking area update timer */
...
k_enodeb=0; /* Key for Access Stratum */	
k_nas_enc=0; /* Key for NAS Encryption / Decryption */
k_nas_int=0; /* Key for NAS Integrity check */
nas_enc_algo=0; /* Idenitifier of NAS Encryption / Decryption */
nas_int_algo=0; /* Idenitifier of NAS Integrity check */
count=1;
bearer=0;
dir=1;
default_apn=0; /* Default Access Point Name */
apn_in_use=0; /* Access Point Name in Use */
eps_bearer_id=0; /* Evolved Packet System Bearer ID */
e_rab_id=0; /* Evolved Radio Access Bearer ID */	
s1_uteid_ul=0; /* S1 Userplane Tunnel Endpoint Identifier - Uplink */
s1_uteid_dl=0; /* S1 Userplane Tunnel Endpoint Identifier - Downlink */
s5_uteid_ul=0; /* S5 Userplane Tunnel Endpoint Identifier - Uplink */
s5_uteid_dl=0; /* S5 Userplane Tunnel Endpoint Identifier - Downlink */
xres=0;
nw_type=0;
nw_capability=0;
pgw_s5_ip_addr="";
pgw_s5_port=0;
s11_cteid_mme=0; /* S11 Controlplane Tunnel Endpoint Identifier - MME */
s11_cteid_sgw=0; /* S11 Controlplane Tunnel Endpoint Identifier - SGW */
}
