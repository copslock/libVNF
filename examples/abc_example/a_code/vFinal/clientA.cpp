	...
	//        cout<<"start "<<start<<" end "<<end<<" elapsed "<<elapsed<<" duration "<<duration<<endl;
		...
		*/
		...
		//shutdown(socketfd,SHUT_RDWR);
	        cls = close(socketfd);  //oct18 //dec11
		//if(cls<0)
		//	cout<<"close failed "<<i<<endl;
		//sleep(1);
		if(t == 50)
		{
